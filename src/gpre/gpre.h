...
inline constexpr int NAME_SIZE  = 32;
inline constexpr int MAX_CURSOR_SIZE = 64;
inline constexpr int MAX_REF_SIZE = 32; // references are generated by gpre
inline constexpr int ERROR_LENGTH = 256;
inline constexpr int MAX_DATABASES = 32;
inline constexpr int MAX_EVENT_SIZE = 16; // event names use 15 chars from old docs.
...
inline constexpr size_t ADL_LEN = sizeof(adl);
...
inline constexpr size_t DIM_LEN = sizeof(dim);
...
inline constexpr size_t FIL_LEN = sizeof(gpre_file);
...
inline constexpr size_t FLTR_LEN = sizeof(gpre_filter);
...
inline constexpr FB_SIZE_T NOD_LEN(const FB_SIZE_T cnt) noexcept
{
...
inline constexpr size_t SDT_LEN = sizeof(set_dialect);
...
inline constexpr size_t SGEN_LEN = sizeof(set_gen);
...
inline constexpr size_t STR_LEN(const size_t size) noexcept
{
...
inline constexpr size_t TXT_LEN = sizeof(gpre_txt);
...
inline constexpr size_t USN_LEN = sizeof(gpre_usn);
...
inline constexpr size_t VAL_LEN = sizeof(gpre_value);
...
inline constexpr size_t ARY_LEN = sizeof(ary);
...
inline constexpr size_t TRG_LEN = sizeof(gpre_trg);
...
inline constexpr size_t LLS_LEN = sizeof(gpre_lls);
...
inline constexpr size_t CNSTRT_LEN = sizeof(cnstrt);
...
inline constexpr size_t PRV_LEN = sizeof(prv);
...
inline constexpr size_t STS_LEN = sizeof(sts);
enum sts_flags_vals {
...
inline constexpr size_t CMPF_LEN = sizeof(cmpf);
...
inline constexpr size_t ACT_LEN = sizeof(act);
...
inline constexpr size_t SYM_LEN = sizeof(gpre_sym);
...
inline constexpr size_t BLB_LEN = sizeof(blb);
...
inline constexpr size_t RRL_LEN = sizeof(rrl);
...
inline constexpr size_t DBB_LEN = sizeof(gpre_dbb);
...
inline constexpr FB_SIZE_T TPB_LEN(const FB_SIZE_T tpb_string_len) noexcept
{
...
inline constexpr size_t PRC_LEN = sizeof(gpre_prc);
enum prc_flags_vals {
	PRC_scanned = 1
};
...
inline constexpr FB_SIZE_T RSE_LEN(const FB_SIZE_T cnt) noexcept
{
...
inline constexpr size_t REL_LEN = sizeof(gpre_rel);
...
inline constexpr size_t IND_LEN = sizeof(gpre_index);
...
inline constexpr size_t INTLSYM_LEN = sizeof(intlsym);
...
inline constexpr size_t POR_LEN = sizeof(gpre_port);
...
inline constexpr FB_SIZE_T SLC_LEN(const FB_SIZE_T count) noexcept
{
...
public:
	...
	inline void add_word(const int word) noexcept
	{
		add_byte(word);
		add_byte(word >> 8);
	}
	inline void add_long(const long lg) noexcept
	{
		add_word(lg);
		add_word(lg >> 16);
	}
	inline void add_cstring(const char* string) noexcept
	{
...
inline constexpr size_t REQ_LEN = sizeof(gpre_req);
...
inline constexpr size_t CTX_LEN = sizeof(gpre_ctx);
...
inline constexpr size_t REF_LEN = sizeof(ref);
...
inline constexpr size_t BAS_LEN = sizeof(bas);
...
inline constexpr size_t DECL_UDF_LEN = sizeof(decl_udf);
...
inline constexpr size_t DYN_LEN = sizeof(dyn);
...
inline constexpr size_t TRA_LEN = sizeof(gpre_tra);
...
inline constexpr int MAX_TRA_OPTIONS	= 8;
...
inline constexpr size_t OPN_LEN = sizeof(open_cursor);
...
inline constexpr size_t RDY_LEN = sizeof(rdy);
...
inline constexpr size_t TYP_LEN = sizeof(field_type);
...
inline constexpr size_t UDF_LEN = sizeof(udf);
...
inline constexpr size_t UPD_LEN = sizeof(upd);
